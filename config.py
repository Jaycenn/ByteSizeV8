...
APP_VERSION = "1.3.0"
# The Hybrid-Huffman algorithm remains v4. AFC5 is the integrity envelope and
# AFC6 the PDF component manifest, not a replacement entropy codec.
ENGINE_VERSION = "AFC v4 (AFC1-AFC6)"
